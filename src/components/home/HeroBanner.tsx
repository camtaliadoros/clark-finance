  ...
  return (
    <>
      <div className='w-full'>
        <div
          className='bg-hero-image bg-bottom md:bg-center bg-cover lg:bg-fixed z-0  flex flex-col justify-center px-4 md:px-12 md:px-18 lg:px-24 2xl:px-60'
          style={{ height: '32rem' }}
        >
          <h2 className='text-chalk font-normal'>{subtitle}</h2>
          <hr className='border-chalk border-t-2 w-20' />
          <h1 className='text-chalk font-semibold mt-2 '>{title}</h1>
